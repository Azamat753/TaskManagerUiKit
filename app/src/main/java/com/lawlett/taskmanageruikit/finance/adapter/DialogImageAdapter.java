...
public class DialogImageAdapter extends RecyclerView.Adapter<DialogImageAdapter.ViewHolder> {
    ...
    public DialogImageAdapter() {
        int[] image = new int[]{R.drawable.ic_01, R.drawable.ic_baseline_coffee_24, R.drawable.ic_03, R.drawable.ic_04,
                ...
                R.drawable.ic_home, R.drawable.ic_18, R.drawable.ic_19, R.drawable.ic_20,
                R.drawable.ic_21, R.drawable.ic_22, R.drawable.ic_wifi, R.drawable.ic_fastfood};
//                R.drawable.ic_person, R.drawable.ic_lock, R.drawable.ic_timer, R.drawable.ic_add_task,
//                R.drawable.ic_02, R.drawable.ic_13, R.drawable.ic_14, R.drawable.ic_17,
//                R.drawable.ic_23, R.drawable.ic_checklist, R.drawable.ic_taxi, R.drawable.ic_habit};
        for (int i : image) {
            list.add(i);
        }
