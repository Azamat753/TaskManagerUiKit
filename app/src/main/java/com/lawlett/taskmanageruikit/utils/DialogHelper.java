...
public class DialogHelper {
    ...
    public void myDialog(Context context, ActionForDialogSecond actionForDialogSecond, String title, String message){
        ...
        builder.setTitle(title)
                .setMessage(message)
                .setPositiveButton(R.string.yes, (dialogInterface, i) -> actionForDialogSecond.pressOkSecond()).setNegativeButton(R.string.no, (dialogInterface, i) -> dialogInterface.cancel()).show();
    }
}
